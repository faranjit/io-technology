...
| Window   | Measured as    | July, Firestore | September, SQL Connect | Requests |
| -------- | -------------- | --------------- | ---------------------- | -------- |
| 1 year   | filter change  | 10.2s           | **2.8s**               | 13 → 1   |
| 3 years  | cold page load | 8.0s            | **5.3s**               | 18 → 2   |
| 5 years  | filter change  | 29.1s           | **3.4s**               | 33 → 1   |
| 7 years  | filter change  | 43.4s           | **3.2s**               | 38 → 1   |
| 10 years | filter change  | 56.0s           | **3.7s**               | 31 → 1   |
